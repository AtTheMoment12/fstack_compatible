 ...
 *   /home/lz/important/f-stack/lib/../freebsd/kern/bus_if.m
 * with
 *   makeobjops.awk
 *
...
/** @brief Unique descriptor for the BUS_MAP_INTR() method */
extern struct kobjop_desc bus_map_intr_desc;
/** @brief A function implementing the BUS_MAP_INTR() method */
typedef int bus_map_intr_t(device_t _dev, device_t _child, int *_rid,
                           rman_res_t *_start, rman_res_t *_end,
                           rman_res_t *_count, struct intr_map_data **_imd);
/**
...
static __inline int BUS_MAP_INTR(device_t _dev, device_t _child, int *_rid,
                                 rman_res_t *_start, rman_res_t *_end,
                                 rman_res_t *_count,
                                 struct intr_map_data **_imd)
{
	kobjop_t _m;
	KOBJOPLOOKUP(((kobj_t)_dev)->ops,bus_map_intr);
	return ((bus_map_intr_t *) _m)(_dev, _child, _rid, _start, _end, _count, _imd);
}
